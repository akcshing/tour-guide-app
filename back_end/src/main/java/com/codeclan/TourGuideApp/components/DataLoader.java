...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        Attraction holyrood = new Attraction("Palace of Holyroodhouse","Canongate, Edinburgh EH8 8DX, Scotland","The Palace of Holyroodhouse is the official residence in Scotland of Her Majesty The Queen. Open throughout the year, the Palace of Holyroodhouse stands at the end of Edinburgh's Royal Mile. Explore the Palace's close associations with some of Scotland’s most well-known historic figures such as Mary, Queen of Scots and Bonnie Prince Charlie, and learn how today it is used by The Queen when carrying out official engagements in Scotland.",16.00,"https://www.virginexperiencedays.co.uk/content/img/product/large/visit-to-palace-of-27150249.jpg",AccessibilityType.WHEELCHAIRACCESS,"Castle", TimeOfDayType.MORNING);
